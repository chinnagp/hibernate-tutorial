	...
	public static void main(String[] args) {
		// create session factory
				...
				try {
					...
					Student newStudent1 = new Student("John", "Doe", "john@chinnag.com");
					Student newStudent2 = new Student("Mary", "PUblic", "mary@chinnag.com");
					Student newStudent3 = new Student("Bonita", "Applebum", "bonita@chinnag.com");
					// start a transaction
